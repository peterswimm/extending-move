# Windows 11 Setup Guide for Ableton Move

This guide will help you set up SSH access and file transfer to your Ableton Move device using Windows 11's built-in tools.
...
WSL provides a Linux environment that makes SSH setup much easier on Windows.
...
1. **Open Ubuntu (WSL):**
   - Type "Ubuntu" in the Windows search bar and press Enter
   - Or open Windows Terminal and type `wsl`
...
- Downloads: `/mnt/c/Users/YourUsername/Downloads/`
- Documents: `/mnt/c/Users/YourUsername/Documents/`

**Example - Copy from Windows Desktop to Move:**
```bash
scp /mnt/c/Users/YourUsername/Desktop/mysample.wav move:/data/UserData/UserLibrary/Samples/
```
...
1. **Download the extending-move files:**
   ```bash
   cd ~
...
1. **Always use forward slashes (/)** in file paths when using WSL/Ubuntu
...
- Create custom drum kits and chord sets
